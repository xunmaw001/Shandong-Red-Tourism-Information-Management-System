<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		...
		.top-brand .menu-list-title {
			...
			background-image: url(http://codegen.caihongy.cn/20201024/ed5e326ca66f403aa3197b5fbb4ec733.jpg);
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">山东红色旅游信息管理系统</a>
						</div>
