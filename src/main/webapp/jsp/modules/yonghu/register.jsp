...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210721/d4f6f885cbe14e25a5a3f2272984a0b3.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		box-shadow: 8px 8px 6px rgba(11,11,11,1);
	}
	...
	#login-wrapper h1 {
		...
		border-style: solid;
		border-color: rgba(0, 0, 0, 0);
		background-color: rgba(255, 68, 86, 1);
	...
	#registerForm button.pull-right {
		...
		box-shadow: 6px 5px 6px rgba(11,11,11,0);
	}
