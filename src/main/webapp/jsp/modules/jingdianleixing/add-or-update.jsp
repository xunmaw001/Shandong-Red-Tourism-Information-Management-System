					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑景点类型</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>景点类型</label>
										<input name="jingdianleixing" id="jingdianleixing" name="jingdianleixing" class="form-control" placeholder="景点类型">
									</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jingdianleixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jingdianleixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jingdianleixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jingdianleixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#jingdianleixing").val(ruleForm.jingdianleixing);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jingdianleixing != null && res.data.jingdianleixing != ''){
						...
						$("#jingdianleixing").val(res.data.jingdianleixing);
						$("#jingdianleixing").attr('readonly','readonly');
					}
				}
			});  
            }
