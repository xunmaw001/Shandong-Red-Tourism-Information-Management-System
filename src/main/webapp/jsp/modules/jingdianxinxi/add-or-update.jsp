...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>等级</label>
										<select id="dengjiSelect" name="dengji" class="form-control">
												<option value=""></option>
												<option class="dengjiOption" value="A">
													A
												</option>
												<option class="dengjiOption" value="AA">
													AA
												</option>
												<option class="dengjiOption" value="AAA">
													AAA
												</option>
												<option class="dengjiOption" value="AAAA">
													AAAA
												</option>
												<option class="dengjiOption" value="AAAAA">
													AAAAA
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>票价</label>
										<input name="piaojia" id="piaojia" name="piaojia" class="form-control" placeholder="票价">
									</div>
									<div class="form-group col-md-6">
										<label>票数</label>
										<input name="piaoshu" id="piaoshu" name="piaoshu" class="form-control" placeholder="票数">
									</div>
									<div class="form-group col-md-6">
										<label>城市</label>
									...
									<div class="form-group col-md-6">
										<label>服务电话</label>
										<input name="fuwudianhua" id="fuwudianhua" name="fuwudianhua" class="form-control" placeholder="服务电话">
									</div>
									<div class="form-group col-md-6">
										<label>详细地址</label>
										<input name="xiangxidizhi" id="xiangxidizhi" name="xiangxidizhi" class="form-control" placeholder="详细地址">
									</div>
	...
	<script>
		...
		var jingdianleixingOptions = [];

		function jingdianleixingSelect(){
			http("option/jingdianleixing/jingdianleixing","GET",{},(res)=>{
				if(res.code == 0){
					jingdianleixingOptions = res.data;
					var nullOption = document.createElement('option');
					var jingdianleixingSelect = document.getElementById('jingdianleixingSelect');
					jingdianleixingSelect.appendChild(nullOption);
					for(var i=0;i<jingdianleixingOptions.length;i++){
						var jingdianleixingOption = document.createElement('option');
						jingdianleixingOption.setAttribute('name','jingdianleixingOption');
						jingdianleixingOption.setAttribute('value',jingdianleixingOptions[i]);
						jingdianleixingOption.innerHTML = jingdianleixingOptions[i];									
						if(ruleForm.jingdianleixing == jingdianleixingOptions[i]){
							jingdianleixingOption.setAttribute('selected','selected');
						}
						jingdianleixingSelect.appendChild(jingdianleixingOption);
					}
				}
			});
		}	
		...
		function dataBind(){
			...
			var dengjiOptions = document.getElementsByClassName("dengjiOption");
			for(var dengjiCount = 0; dengjiCount < dengjiOptions.length;dengjiCount++){
				if(dengjiOptions[dengjiCount].getAttribute('value') == ruleForm.dengji){
					dengjiOptions[dengjiCount].setAttribute('selected','selected');
				}
			}
			...
			$("#fuwudianhua").val(ruleForm.fuwudianhua);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.dengji != null && res.data.dengji != ''){
						...
						var dengjiOptions = document.getElementsByClassName("dengjiOption");
						for(var dengjiCount = 0; dengjiCount < dengjiOptions.length;dengjiCount++){
							if(dengjiOptions[dengjiCount].getAttribute('value') == res.data.dengji){
								dengjiOptions[dengjiCount].setAttribute('selected','selected');
							}
						}
					}
					...
					if(res.data != null && res.data != '' && res.data.fuwudianhua != null && res.data.fuwudianhua != ''){

						$("#fuwudianhua").val(res.data.fuwudianhua);
						$("#fuwudianhua").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.xiangxidizhi != null && res.data.xiangxidizhi != ''){

						$("#xiangxidizhi").val(res.data.xiangxidizhi);
						$("#xiangxidizhi").attr('readonly','readonly');
					}
